...
class NaiveCRSA:
    ...
    def __init__(self, meanings_A, meanings_B, categories, utterances, lexicon_A, lexicon_B, prior):
    ...
    def run_turn(self, speaker="A", costs=None, alpha=1.0, max_depth=float('inf'), tolerance=1e-3, update_lexicon=False):
